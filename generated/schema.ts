...
export class transaction extends Entity {
  ...
  get listedNfts(): Array<string> | null {
    let value = this.get("listedNfts");
    if (!value || value.kind == ValueKind.NULL) {
      return null;
    } else {
      return value.toStringArray();
  ...
  set listedNfts(value: Array<string> | null) {
    if (!value) {
      this.unset("listedNfts");
    } else {
      this.set("listedNfts", Value.fromStringArray(<Array<string>>value));
    }
  }
}
